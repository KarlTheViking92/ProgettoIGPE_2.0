...
public class PausePane extends Pane {
	...
	public PausePane(SinglePlayerPane g) {
		...
		game = g;
		background = new Rectangle(Screen.getPrimary().getBounds().getWidth(),
		...
		restart.setLayoutY(
				resume.getLayoutY() + restart.getHeight() + Screen.getPrimary().getBounds().getHeight() * 0.05);
		mainMenu.setLayoutY(
				restart.getLayoutY() + mainMenu.getHeight() + Screen.getPrimary().getBounds().getHeight() * 0.05);
		exitGame.setLayoutY(
				mainMenu.getLayoutY() + exitGame.getHeight() + Screen.getPrimary().getBounds().getHeight() * 0.05);
