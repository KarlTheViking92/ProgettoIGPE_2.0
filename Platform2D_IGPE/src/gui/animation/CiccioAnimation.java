...
public class CiccioAnimation implements CharacterAnimation {

	private final static String PATH_FRAME = "file:resources/images/character/ciccio";

	private final static Image[] STATIC_FRAMES = { new Image(PATH_FRAME + "/Static/staticframe1.png"),
	...
	private final static Image[] ATTACK_FRAMES = { new Image(PATH_FRAME + "/Attack/Ranged/Ranged5.png") };
