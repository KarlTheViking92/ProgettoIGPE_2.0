...
public class DataContainer extends AbstractCustomComponent{
	...
	private final Font font = Font.loadFont("file:resources/font/Engcomica.otf", Screen.getPrimary().getBounds().getWidth()*0.032); 
...
//		this.setComponentBackground("finishPanel/dataBackground");
